      ...
      <div class="container">
        ...
        <div class="col-lg-9">
              ...
              <div class="card border-0 border-radius-0 mb-5 box-shadow-1">
                <div class="card-body p-4 z-index-1">
                  ...
                  <div class="card-body p-0">
                    ...
                    <a href="<?= base_url('dashboard/announcement?slug=') . $announcement->slug ?>" class="font-weight-bold text-uppercase text-decoration-none d-block mt-3">Baca Selengkapnya</a>
                  </div>
                </div>
              </div>
            </article>
          ...
          <div class="col-lg-3">
            <aside class="sidebar">
              <div class="px-3 mb-4">
                <h3 class="text-color-secondary text-capitalize font-weight-bold text-5 m-0 mb-3">Pengumuman Terkini</h3>
