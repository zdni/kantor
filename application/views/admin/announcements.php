                    ...
                    <tbody>
                      <?php $number = 1; foreach ($datas as $data) {  ?>
                        <tr>
                          ...
                          <td>
                            <a href="<?= base_url('admin/announcements/detail/') . $data->id ?>" class="btn btn-sm btn-outline-info">Detail</a>
                            <a href="<?= base_url('admin/announcements/form/') . $data->id ?>" class="btn btn-sm btn-outline-secondary">Edit</a>
